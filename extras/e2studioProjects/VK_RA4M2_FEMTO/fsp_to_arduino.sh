...
# Clean files
rm -f ${CORE_PATH}/variants/${TARGET}/defines.txt
rm -f ${CORE_PATH}/variants/${TARGET}/includes.txt
rm -f ${CORE_PATH}/variants/${TARGET}/cflags.txt
rm -f ${CORE_PATH}/variants/${TARGET}/cxxflags.txt
...
then
    ...
    rm -rf ${CORE_PATH}/variants/${TARGET}/includes/*
fi
