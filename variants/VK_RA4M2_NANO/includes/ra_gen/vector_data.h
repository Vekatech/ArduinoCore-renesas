...
#define VECTOR_NUMBER_SPI0_RXI ((IRQn_Type) 7) /* SPI0 RXI (Receive buffer full) */
#define SPI0_RXI_IRQn          ((IRQn_Type) 7) /* SPI0 RXI (Receive buffer full) */
#define VECTOR_NUMBER_SPI0_TXI ((IRQn_Type) 8) /* SPI0 TXI (Transmit buffer empty) */
#define SPI0_TXI_IRQn          ((IRQn_Type) 8) /* SPI0 TXI (Transmit buffer empty) */
...
#define VECTOR_NUMBER_SCI0_RXI ((IRQn_Type) 11) /* SCI0 RXI (Receive data full) */
#define SCI0_RXI_IRQn          ((IRQn_Type) 11) /* SCI0 RXI (Receive data full) */
...
#define VECTOR_NUMBER_DOC_INT ((IRQn_Type) 23) /* DOC INT (Data operation circuit interrupt) */
#define DOC_INT_IRQn          ((IRQn_Type) 23) /* DOC INT (Data operation circuit interrupt) */
#define VECTOR_NUMBER_FCU_FRDYI ((IRQn_Type) 24) /* FCU FRDYI (Flash ready interrupt) */
#define FCU_FRDYI_IRQn          ((IRQn_Type) 24) /* FCU FRDYI (Flash ready interrupt) */
#define VECTOR_NUMBER_FCU_FIFERR ((IRQn_Type) 25) /* FCU FIFERR (Flash access error interrupt) */
#define FCU_FIFERR_IRQn          ((IRQn_Type) 25) /* FCU FIFERR (Flash access error interrupt) */
#ifdef __cplusplus
        }
        #endif
#endif /* VECTOR_DATA_H */
